...
public class SpiIndexQueryImpl<T> implements SpiQueryAdapter<T> {
	...
	public List<T> getResultListImpl() throws ParseException, IOException {
	    ...
	    IndexReader reader = IndexReader.open(index.getRamDirectory());
