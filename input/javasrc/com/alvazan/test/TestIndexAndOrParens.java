...
public class TestIndexAndOrParens {
	...
	public void testBooleanWithAndClause() {
		...
		printList("'And' activeList", activeList);
		printList("'And' reversedActiveList", reversedList);
		...
		printList("'Or' activeList", orList);
		printList("'Or' reversedActiveList", reversedList);
